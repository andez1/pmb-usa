							...
							<div class="feature-container">
								<div class="icon-content mb-2">
									<p style="text-indent: 50px; text-align: justify">
                                        Indonesia sudah berada diambang batas menuju Era Revolusi Industry 4.0 dimana karakteristik pengembangan Teknologi Informasi bersifat disruptif di segala sektor dan bidang. Selain itu market global semakin bersifat transparan dan sharing economy. Hal tersebut juga berdampak signifikan pada pendidikan dimana perguruan tinggi dituntut untuk dapat memberikan layanan pendidikan dengan semakin transparan dan memenuhi kebutuhan pasar global. Perguruan tinggi sebagai penghasil human resource excelence ditantang untuk lebih mengelaborasi keahlian-keahlian yang berorientasi inovasi, break-through invention, high-creativity dan multi-complex cooperation. Dengan memperhatikan tantangan dan mendesaknya kebutuhan tersebut, perguruan tinggi sudah saatnya bertransformasi dari basis konvensional menjadi basis pengembangan ilmu dan teknologi berbasis advances Information Technology. Salah satu bentuk transformasi tersebut adalah dirasa perlu untuk menuju layanan pendidikan tinggi yang berbasis cyber platform. Untuk itulah Yayasan Memajukan Ilmu dan Kebudayaan memiliki motivasi untuk mengusulkan pendirian Universitas Siber Asia sebagai tindak lanjut kebijakan Kemenristekdikti dan MoU yang telah dilakukan pada 2016. Dengan mendirikan Universitas Siber Asia di Indonesia perguruan tinggi semakin kompetitif dalam memberikan layanan akses pendidikan tinggi yang bermutu, masif dan memenuhi kualifikasi untuk bisa sukses dalam Era Revolusi Industry 4.0.
                                    </p>
                                    <p style="text-indent: 50px; text-align: justify">
                                        Indonesia memiliki keunggulan komparatif yakni bonus demografi dimana usia muda dan produktif sangat mendominasi prosentase dari komposisi SDM (Sumber Daya Manusia). Hal tersebut merupakan peluang besar dalam dunia pendidikan untuk menciptakan formula pendidikan tinggi yang berbasis Cyber University dengan misi utama yakni mencerdaskan kehidupan berbangsa dan bernegara. Data terakhir dari Kementristek Dikti dan BPS bahwa populasi usia 19 – 23 Tahun dari tahun 2005 hingga 2017 adalah terakumulasi sebesar 19,32 juta jiwa, sebagaimana ditunjukkan pada Gambar 1 - 4. Sementara jumlah PTN/PTS yang telah ada hingga 2017 adalah sekitar 4500 buah. Serta daya tampung mahasiswa oleh PTN/PTS dari tahun 2005 – 2017 rata-rata per tahun adalah 5,48 juta jiwa, sebagaimana ditunjukkan pada Gambar 2. Hal tersebut menunjukkan disparitas yang tinggi, yakni setiap tahun dari 2005 hingga 2017, hanya sekitar 29,36% dari populasi yang dapat menjadi mahasiswa atau masuk kuliah. Kondisi demikian dikonfirmasi oleh data Angka Partisipasi Kasar (APK) untuk jenjang pendidikan tinggi, yakni sebagaimana ditunjukkan pada Gambar 3, bahwa APK pada tahun 2005 sebesar 18,2% meningkat hingga 31,15% pada 2017. Peningkatan APK selama 13 Tahun tersebut tidaklah begitu pesat atau signifikan jika dibandingkan dengan data APK di wilayah ASEAN yang rata-rata berada pada kisaran >35%. Kondisi demikian merupakan tantangan dan peluang dalam kerangka memberikan akses pendidikan tinggi seluas-luasnya di usia produktif pada 19 – 23 tahun agar dapat meningkatkan APK, dimana target APK Kemenristekdikti pada 2016 – 2017 adalah sebesar 40%.
                                    </p>
								</div>
                                <div class="text-center mb-5">
                                    <img src="{{ asset('homepages/images/about/about-image1.png') }}" alt="">
                                    <p>
                                        Populasi usia produktif pada 19 – 23 tahun dari tahun 2005 hingga 2017 (Sumber: BPS).
                                    </p>
                                </div>
                                <div class="text-center mb-5">
                                    <img src="{{ asset('homepages/images/about/about-image2.png') }}" alt="">
                                    <p>
                                        Populasi mahasiswa produktif pada 19 – 23 tahun yang diterima oleh PTN/PTS untuk tahun</br> 2005 hingga 2017 (Sumber BPS dan Laporan Tahunan Kemenristekdikti).
                                    </p>
                                </div>
                                <div class="text-center mb-5">
                                    <img src="{{ asset('homepages/images/about/about-image3.png') }}" alt="">
                                    <p>
                                        Angka Partisipasi Kasar (APK) pada usia produktif pada 19 – 23 tahun yang diterima oleh</br> PTN/PTS untuk tahun 2005 hingga 2017 (Sumber BPS dan Laporan Tahunan Kemenristekdikti).
                                    </p>
                                </div>
                                <div class="text-center mb-3">
                                    <img src="{{ asset('homepages/images/about/about-image4.png') }}" alt="">
                                    <p>
                                        Data sensus penduduk Indoneisa usia produktif 15 tahun ke atas pada 2017 (Sumber BPS).
                                    </p>
                                </div>
                                <div>
                                    <p>
                                        Serta dengan memperhatikan data lulusan setiap tahun SMK secara nasional yakni berkisar dari 1,8 - 2 juta siswa per tahun, maka Universitas Siber Asia berpeluang untuk memberikan layanan pendidikan on-line dalam mempersiapkan lulusan yang mampu menguasai bahasa Korea untuk selanjutnya disalurkan pada perusahaan Korea/Jepang yang telah beroperasi di Indonesia.
                                    </p>
                                    <p style="text-indent: 50px; text-align: justify">
                                        Untuk dapat meningkatkan APK setiap tahun, dimana target Kemenristekdikti adalah sebesar 40%, dengan mempertimbangkan menambah jumlah PTN/PTS adalah high-cost dan membutuhkan waktu Setup Operasional yang cukup lama, untuk itu mode pelayanan akses pendidikan tinggi perlu ditransformasi dari basis layanan konvensional menjadi layanan pendidikan tinggi berbasis Full On-Line Learning. Sehingga dengan potensi jumlah PTN/PTS yang sudah ada yakni 4500 buah dan dengan memanfaatkan kemajuan di era Revolusi Industry 4.0, APK dapat ditingkatkan secara signifikan dimana layanan akses pendidikan tinggi menjadi semakin terbuka. Keunggulan dengan melakukan transformasi dari layanan PTN/PTS yang berbasis pengajaran konvensional menjadi layanan berbasis Full On-Line Learning adalah biaya operasional dapat ditekan, mutu kelola PTN/PTS dapat ditingkatkan mengacu pada standar akreditasi internasional, dapat menggelar layanan pendidikan tinggi secara masif, dan meningkatkan kualitas pembelajaran.
                                    </p>
                                    <p style="text-indent: 50px; text-align: justify">
                                        Pada Agustus 2019, Kemenristekdikti telah menyetujui dan memberikan izin prinsip pendirian Universitas Siber Asia guna dilakukan persiapan-persiapan infrastruktur pendukung untuk beroperasinya perguruan tinggi online pertama di Indonesia. Dalam kesempatan Peringatan Harteknas 2019, Bapak Prof. Mohammad Natsir selaku Menteri Riset dan Pendidikan Tinggi mengapresiasi niatan mulia Yayasan Memajukan Ilmu dan Kebudayaan dalam membantu upaya pemerintah meningkatan kuantitas dan kualitas pendidikan tinggi dengan metode layanan online. Bapak Menteri berharap kelak, Universitas Siber Asia menjadi World Class University.
                                    </p>
                                    <p style="text-indent: 50px; text-align: justify">
                                        Dengan landasan-landasan dan uraian latar belakang tersebut Yayasan Memajukan Ilmu dan Kebudayaan bekerja sama dengan Hankook Cyber University mengajukan izin pendirian Perguruan Tinggi Online pertama di Indonesia dengan tujuan sebagai berikut:
                                    </p>
                                    <ol class="ml-3">
                                        <li>
                                        ...
                                        <li>
                                            <p style="text-align: justify">
                                                Mempersiapkan Sumber Daya Manusia yang siap bersaing dan berkiprah di era Revolusi Industry 4.0 dengan bekal kemampuan IT literacy yang tinggi dan mampu mendayagunakan sebagai Driven Digital Economy.
                                            </p>
                                        </li>
                                        <li>
                                            <p style="text-align: justify">
                                        ...
                                        <li>
                                            <p style="text-align: justify">
                                                Mempersiapkan roadmap pengembangan Revolusi Industry 4.0 menuju Era Smart Society 5.0 berbasis penguasaan teknologi digital.
                                            </p>
                                        </li>
                                    </ol>
                                </div>
