                ...
                <div class="col-lg-12 col-md-12 col-sm-12 m-b30">
                    <div class="feature-container">
                        <div class="icon-content mb-2">
                            <p>Sebagai tindak lanjut kebijakan “Kampus Merdeka” yang telah dicanangkan oleh Kemendikbud melalui peraturan No. 3 Tahun 2020, UNSIA mengadakan program akademik sebagai berikut:</p>
                            <ol class="ml-4">
                                <li>
                                ...
                                <li>
                                    ...
                                    <p>Persyaratan untuk jalur rekognisi kompetensi:</p>
                                    <ul class="ml-4">
